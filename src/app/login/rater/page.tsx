...
export default function LoginRater() {
    ...
    <>
      ...
      <main className="route theme-rater">
        <section className="py-16">
          <Container>
            <h2 className="text-3xl font-black mb-6">Log in (Rater)</h2>
            <form onSubmit={onSubmit} className="card grid gap-3 max-w-md">
              ...
              <button className="btn-3d bg-[--accent] text-black rounded-full px-5 py-3 shadow-neon-rater">Log in</button>
